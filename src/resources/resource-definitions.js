...
const resources = {
  instituicoes: {
    ...
    writableColumns: ["nome", "cnpj", "endereco", "numero", "cep", "telefone", "logo", "usa_acompanhamento", "usa_frota", "ativo"],
  ...
  veiculos: {
    ...
    tableName: "veiculos",
    tenantColumn: "instituicao_id",
    searchableColumns: ["nome", "placa", "modelo"],
    writableColumns: [
      "instituicao_id",
      "nome",
      "placa",
      ...
      "intervalo_troca_oleo_dias",
      "quilometragem_ultima_troca_oleo",
      "data_ultima_troca_oleo",
      "situacao",
      "ativo",
    ],
    requiredOnCreate: ["instituicao_id", "nome", "placa"],
  },
  setores: {
    route: "setores",
    tableName: "setores",
